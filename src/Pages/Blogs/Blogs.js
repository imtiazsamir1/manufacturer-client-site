    ...
    <div className="max-w-7xl mx-auto px-12">
      ...
      <div className="container sm:container my-5">
        ...
        <div className="card bg-base-100  lg:w-full shadow-xl mt-5 p-12">
          ...
          <p className="">
            {" "}
            <b>Ans:</b>Unit tests are typically automated tests written and run
            ...
            more commonly an individual function or procedure.Unit testing
        ...
        <div className="card bg-base-100  lg:w-full shadow-xl mt-5 p-12">
          ...
          <p className="">
            ...
            method determines whether an array includes a certain value among
            its entries, returning true or false as appropriate.includes()
            method is intentionally generic. It does not require this value to
            be an Array object, so it can be applied to other kinds of objects
            (e.g. array-like objects).
          </p>
        </div>
        <div className="card bg-base-100  lg:w-full shadow-xl mt-5 p-12">
          <h1 className="text-2xl font-bold">
