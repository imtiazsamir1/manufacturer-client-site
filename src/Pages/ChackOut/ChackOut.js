...
const ChackOut = () => {
  ...
  const { data, isLoading } = useQuery(["order", paymentID], () =>
    axios.get(`http://localhost:5000/order/${paymentID}`)
  );
  ...
  useEffect(() => {
    axios
      .post(
        // `https://fathomless-refuge-70069.herokuapp.com/create-payment-intent`,
    ...
    stripe
      ...
      .then(function (result) {
        ...
        if (result.paymentIntent) {
          ...
          axios.put(`http://localhost:5000/order/${paymentID}`, {
            payment: true,
  ...
  return (
    <div>
      <div className="flex justify-center my-12">
        <div className="card lg:w-1/2 w-full  bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <form
              className="card-body shadow-xl rounded-xl my-12"
            ...
            >
              ...
              <button
                className="btn mt-10 btn-outline btn-success w-sm"
                type="submit"
      ...
      <div>
        <div className="card lg:max-w-sm flex justify-items-center  bg-base-100 shadow-xl"></div>
      </div>
    </div>
  );
};
