...
const Blogs = () => {
  return (
    <div className="container sm:container my-5 max-w-7xl mx-auto px-12">
      ...
      <div className="card bg-base-100 shadow-xl mt-5 p-12">
        ...
        <p className="">
          {" "}
          <b>Ans:</b> Every object with its methods and properties contains an
      ...
      <div className="card bg-base-100  lg:w-full shadow-xl mt-5 p-12">
        ...
        <p className="">
          {" "}
          <b>Ans:</b>Unit tests are typically automated tests written and run by
          software developers to ensure that a section of an application (known
          as the "unit") meets its design and behaves as intended. In procedural
          programming, a unit could be an entire module, but it is more commonly
          an individual function or procedure.Unit testing ensures that all code
          meets quality standards before it's deployed. This ensures a reliable
      ...
      <div className="card bg-base-100  lg:w-full shadow-xl mt-5 p-12">
        <h1 className="text-2xl font-bold">
          Question: You have an array of products. Each product has a name,
          price, description, etc. How will you implement a search to find
          products by name?
        </h1>
        <p className="">
          {" "}
          <b>Ans:</b>I will use javascript includes() mathodsThe includes()
          method determines whether an array includes a certain value among its
          entries, returning true or false as appropriate.includes() method is
          intentionally generic. It does not require this value to be an Array
          object, so it can be applied to other kinds of objects (e.g.
          array-like objects).
        </p>
      </div>
      <div className="card bg-base-100  lg:w-full shadow-xl mt-5 p-12">
